...
void writefile(char const* filename)
{
	...
	case 6:
		...
		break;
	case 7:
		outfile << "	mov	r3, #12" << endl; break;
	case 8:
		outfile << "	ldr	r3, [fp, #-12]	@ float   " << endl;  break;  
	case 9:
		outfile << "	str	r3, [fp, #-12]	@ float   " << endl;  break;  
		}
...
int main()
{
	...
	openfile("/home/pan/Ubuntu/DVFS/GAN/gem5-dvfs/123.txt");
	writefile("/home/pan/Ubuntu/DVFS/GAN/gem5-dvfs/shiyishi.S");
	cout << "ok" << endl;
	return 0;
